...
void main() {
  testWidgets('App widget should show CompaniesListPage', (WidgetTester tester) async {
    ...
    // Verify that CompaniesListPage is shown
    expect(find.byType(CompaniesListPage), findsOneWidget);
  });
}
